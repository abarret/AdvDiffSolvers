 ...
 */
class RBFPoissonSolver : public IBTK::PoissonSolver
{
public:
    /*!
     ...
     */
    RBFPoissonSolver(std::string object_name,
...
private:
     ...
     */
    RBFPoissonSolver(const RBFPoissonSolver& from) = delete;
     ...
     */
    RBFPoissonSolver& operator=(const RBFPoissonSolver& that) = delete;
...
#endif //#ifndef included_ADS_RBFPoissonSolver
