...
// Local includes
#include "CCPointRelaxationFACOperator.h"
...
CCPointRelaxationFACOperator::CCPointRelaxationFACOperator(const std::string& object_name,
          ...
          std::move(default_options_prefix))
{
    ...
    d_smoother_type = "RED_BLACK_GAUSS_SEIDEL";
    ...
    IBTK_DO_ONCE(t_smooth_error =
                     TimerManager::getManager()->getTimer("IBTK::CCPointRelaxationFACOperator::smoothError()");
                 t_solve_coarsest_level =
                     TimerManager::getManager()->getTimer("IBTK::CCPointRelaxationFACOperator::solveCoarsestLevel()");
                 t_compute_residual =
                     TimerManager::getManager()->getTimer("IBTK::CCPointRelaxationFACOperator::computeResidual()"););
    return;
} // CCPointRelaxationFACOperator

CCPointRelaxationFACOperator::~CCPointRelaxationFACOperator()
{
...
void
CCPointRelaxationFACOperator::setSmootherType(const std::string& smoother_type)
{
#if !defined(NDEBUG)
...
void
CCPointRelaxationFACOperator::setCoarseSolverType(const std::string& coarse_solver_type)
{
    if (d_is_initialized)
    {
...
void
CCPointRelaxationFACOperator::smoothError(SAMRAIVectorReal<NDIM, double>& error,
...
bool
CCPointRelaxationFACOperator::solveCoarsestLevel(SAMRAIVectorReal<NDIM, double>& error,
                                                 const SAMRAIVectorReal<NDIM, double>& residual,
                                                 int coarsest_ln)
{
...
void
CCPointRelaxationFACOperator::computeResidual(SAMRAIVectorReal<NDIM, double>& residual,
                                              ...
                                              int finest_level_num)
{
    ...
    Pointer<CellNoCornersFillPattern> fill_pattern = new CellNoCornersFillPattern(CELLG, false);
...
void
CCPointRelaxationFACOperator::initializeOperatorStateSpecialized(const SAMRAIVectorReal<NDIM, double>& solution,
                                                                 const SAMRAIVectorReal<NDIM, double>& rhs,
                                                                 ...
                                                                 const int finest_reset_ln)
{
    ...
    {
        TBOX_ERROR("CCPointRelaxationFACOperator::initializeOperatorState()\n"
    ...
    d_op_stencil_fill_pattern = new CellNoCornersFillPattern(CELLG, true);
...
void
CCPointRelaxationFACOperator::deallocateOperatorStateSpecialized(const int /*coarsest_reset_ln*/,
                                                                 const int /*finest_reset_ln*/)
{
