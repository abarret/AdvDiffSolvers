...
CCPointFACPreconditionerStrategy::CCPointFACPreconditionerStrategy(std::string object_name,
      ...
      d_coarse_solver_default_options_prefix(default_options_prefix + "_coarse")
{
    ...
    IBTK_DO_ONCE(
        t_restrict_residual =
            TimerManager::getManager()->getTimer("IBTK::CCPointFACPreconditionerStrategy::restrictResidual()");
        t_prolong_error =
            TimerManager::getManager()->getTimer("IBTK::CCPointFACPreconditionerStrategy::prolongError()");
        t_prolong_error_and_correct =
            TimerManager::getManager()->getTimer("IBTK::CCPointFACPreconditionerStrategy::prolongErrorAndCorrect()");
        t_initialize_operator_state =
            TimerManager::getManager()->getTimer("IBTK::CCPointFACPreconditionerStrategy::initializeOperatorState()");
        t_deallocate_operator_state =
            TimerManager::getManager()->getTimer("IBTK::CCPointFACPreconditionerStrategy::deallocateOperatorState()"););
    return;
} // CCPointFACPreconditionerStrategy

CCPointFACPreconditionerStrategy::~CCPointFACPreconditionerStrategy()
{
    if (d_is_initialized)
    {
        TBOX_ERROR(d_object_name << "::~CCPointFACPreconditionerStrategy()\n"
...
void
CCPointFACPreconditionerStrategy::setPoissonSpecifications(const PoissonSpecifications& poisson_spec)
{
...
void
CCPointFACPreconditionerStrategy::setPhysicalBcCoef(RobinBcCoefStrategy<NDIM>* const bc_coef)
{
...
void
CCPointFACPreconditionerStrategy::setPhysicalBcCoefs(const std::vector<RobinBcCoefStrategy<NDIM>*>& bc_coefs)
{
...
void
CCPointFACPreconditionerStrategy::setResetLevels(const int coarsest_ln, const int finest_ln)
{
#if !defined(NDEBUG)
...
void
CCPointFACPreconditionerStrategy::setCoarseSolverMaxIterations(int coarse_solver_max_iterations)
{
...
void
CCPointFACPreconditionerStrategy::setCoarseSolverAbsoluteTolerance(double coarse_solver_abs_residual_tol)
{
...
void
CCPointFACPreconditionerStrategy::setCoarseSolverRelativeTolerance(double coarse_solver_rel_residual_tol)
{
...
void
CCPointFACPreconditionerStrategy::setProlongationMethod(const std::string& prolongation_method)
{
    if (d_is_initialized)
    {
...
void
CCPointFACPreconditionerStrategy::setRestrictionMethod(const std::string& restriction_method)
{
    if (d_is_initialized)
    {
...
void
CCPointFACPreconditionerStrategy::setToZero(SAMRAIVectorReal<NDIM, double>& vec, int level_num)
{
...
void
CCPointFACPreconditionerStrategy::restrictResidual(const SAMRAIVectorReal<NDIM, double>& src,
...
void
CCPointFACPreconditionerStrategy::prolongError(const SAMRAIVectorReal<NDIM, double>& src,
                                               SAMRAIVectorReal<NDIM, double>& dst,
                                               int dst_ln)
{
...
void
CCPointFACPreconditionerStrategy::prolongErrorAndCorrect(const SAMRAIVectorReal<NDIM, double>& src,
                                                         SAMRAIVectorReal<NDIM, double>& dst,
                                                         int dst_ln)
{
...
void
CCPointFACPreconditionerStrategy::initializeOperatorState(const SAMRAIVectorReal<NDIM, double>& solution,
...
void
CCPointFACPreconditionerStrategy::deallocateOperatorState()
{
...
void
CCPointFACPreconditionerStrategy::xeqScheduleProlongation(const int dst_idx, const int src_idx, const int dst_ln)
{
...
void
CCPointFACPreconditionerStrategy::xeqScheduleRestriction(const int dst_idx, const int src_idx, const int dst_ln)
{
...
void
CCPointFACPreconditionerStrategy::xeqScheduleGhostFillNoCoarse(const int dst_idx, const int dst_ln)
{
    d_bc_op->setPatchDataIndex(dst_idx);
    d_bc_op->setPhysicalBcCoefs(d_bc_coefs);
    d_bc_op->setHomogeneousBc(true);
...
void
CCPointFACPreconditionerStrategy::xeqScheduleDataSynch(const int dst_idx, const int dst_ln)
{
    RefineAlgorithm<NDIM> refiner;
