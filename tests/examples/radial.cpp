...
#include <utility>
// Local includes
#include "radial/QFcn.h"
#include "radial/RadialBoundaryCond.h"
#include "radial/SetLSValue.h"

#include "radial/QFcn.cpp"
#include "radial/RadialBoundaryCond.cpp"
#include "radial/SetLSValue.cpp"
...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        pout << "Norms of exact solution at time " << loop_time << ":\n"
             << "  L1-norm:  " << std::setprecision(8) << hier_cc_data_ops.L1Norm(Q_err_idx, wgt_cc_idx) << "\n"
        ...
        pout << "Error in " << Q_var->getName() << " at time " << loop_time << ":\n"
             << "  L1-norm:  " << std::setprecision(8) << hier_cc_data_ops.L1Norm(Q_idx, wgt_cc_idx) << "\n"
